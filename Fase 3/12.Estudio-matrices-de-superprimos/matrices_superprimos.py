...
matrices_superprimos = [[0 for i in range(9)] for j in range((nfin-nin)//2+1)] #En esta lista se van a almacenar todas las matrices de "superprimos" que se encuentren
superprimos = 0
                        ...
                        if x13 > 0 and x21 > 0 and x23 > 0 and x31 > 0:
                            ...
                            if esprimo[x13] and esprimo[x21] and esprimo[x23] and esprimo[x31] and esprimo[x32] and esprimo[x33]:
                                ...
                                if superprimos == 9:
                                    ...
                                    matrices_superprimos[contsuperprimos][0] = matriz[0]
                                    matrices_superprimos[contsuperprimos][1] = matriz[1]
                                    matrices_superprimos[contsuperprimos][2] = matriz[2]
                                    matrices_superprimos[contsuperprimos][3] = matriz[3]
                                    matrices_superprimos[contsuperprimos][4] = matriz[4]
                                    matrices_superprimos[contsuperprimos][5] = matriz[5]
                                    matrices_superprimos[contsuperprimos][6] = matriz[6]
                                    matrices_superprimos[contsuperprimos][7] = matriz[7]
                                    matrices_superprimos[contsuperprimos][8] = matriz[8]
...
nsuperprimos = contsuperprimos  #Numero total de matrices de "superprimos" que se han encontrado

print("Entre " + str(nin) + " y " + str(nfin) + " se han encontrado " + str(nmatrices) + " matrices anidadas de primos")   
print("Entre " + str(nin) + " y " + str(nfin) + " se han encontrado " + str(nsuperprimos) + " matrices anidadas de superprimos")   

print(matrices_superprimos)
